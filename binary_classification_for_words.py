...
def experiment(number, X_train, Y_train, X_test, Y_test, embedding_dimension_paramvalues, LSTM_cellnum_paramvalues, batch_size_num_paramvalues, nb_epoch_num_paramvalues):
    ...
    embedding_dimension, LSTM_cellnum, batch_size_num = choose_parameters_randomly(embedding_dimension_paramvalues, LSTM_cellnum_paramvalues, batch_size_num_paramvalues)

    nb_epoch_num = nb_epoch_num_paramvalues
...
Choosing parameters randomly
"""
def choose_parameters_randomly(embedding_dimension_paramvalues, LSTM_cellnum_paramvalues, batch_size_num_paramvalues):
    ...
    return (embedding_dimension, LSTM_cellnum, batch_size_num)
