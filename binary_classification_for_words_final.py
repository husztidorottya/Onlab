...
"""
def code_ngrams(begin, end, ngrams_n, line):
...
"""
def code_word(category, data, x_set, Y_set, letters, char_num, char_dir, ngrams_enabled, ngrams_n):
    for line in data:
            coded_word = []
            ...
            if len(line) <= char_num:
                ...
                # ngrams enabled
                    ...
                    code_ngrams(0, len(line) - ngrams_n, ngrams_n, line)
            ...
            # word is longer than taken characters
                ...
                if char_dir == 0:
                    ...
                    # ngrams enabled
                        ...
                        # shifting a window along the taken number of characters
                        code_ngrams(0, char_num - ngrams_n, ngrams_n, line)
                ...
                if char_dir == 1:
                    ...
                    # ngrams enabled
                        ...
                        # shifting a window along the taken number of characters
                        code_ngrams((len(line) - char_num), len(line) - ngrams_n, ngrams_n, line)
...
"""
def experiment(number, X_train, Y_train, X_test, Y_test, embedding_dimension, LSTM_cellnum, batch_size_num, nb_epoch_num, char_num, char_dir, ngrams_enabled, ngrams_n):
    # defining model
    model = Sequential()
    ...
    for round in range(0,int(args.experiment_number)):
        ...
        for i in range(0,2):
            ...
            if i == 0:
                ...
                code_word(0, data, x_set, Y_set, letters, char_num, char_dir, ngrams_enabled, ngrams_n)
            else:
                # encoding words and append to dataset and labels
                code_word(1, data, x_set, Y_set, letters, char_num, char_dir, ngrams_enabled, ngrams_n)

        create_padding(x_set, char_dir)
        ...
        # start learning
        experiment(number,X_train,Y_train,X_test,Y_test,embedding_dimension,LSTM_cellnum,batch_size_num,nb_epoch_num, char_num, char_dir, ngrams_enabled, ngrams_n)    
